...
class AdminPanel extends React.Component {
    ...
    render() {
        return (
        <Container style={{ paddingTop: '8vh', paddingBottom: '2vh', paddingLeft: '55vh', paddingRight: '55vh'}} >
        <div className="p-5 my-4 mx-3 mt-5 d-flex justify-content-center bg-light border rounded">
            <Stack>
                <Container className="d-flex justify-content-center">
                        <h3>Admin Panel</h3>
                </Container>
                <Container className="d-flex justify-content-center" style={{ paddingTop: '1vh', paddingLeft: '24vh', paddingRight: '24vh'}}>
                <Stack spacing={4}>
                   <Button className="mb-2 mt-3 btn btn-primary btn-sm" href={diningLocationSelectionUrl}>Edit Dining Locations</Button>
                </Stack>
                </Container>
                <Container className="d-flex justify-content-center" style={{ paddingTop: '2vh', paddingLeft: '6vh', paddingRight: '6vh'}}>
