...
export default class FoodsNeedUpdate extends React.Component {
        ...
        if (this.state.loading) {
            return (
                ...
                <header className="App-header p-3 my-4 mx-4 bg-light border rounded">
                    <h1 className="App-title" style={{textAlignVertical: "center",textAlign: "center"}}><strong>Foods That Need to Be Updated</strong></h1>
