          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              <Stack gap={2}>
                ...
                <p>
                  The following quiz will ask you questions about your food
                  preferences and restrictions. It is solely used to provide
                  better recommendations for you.
                </p>
                <Button onClick={incrementQuestion}>
                  Let's start <i className="bi bi-chevron-right"></i>
                </Button>
              </Stack>
            </div>
          </Container>
          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              ...
              <Container className="d-flex justify-content-center">
                <Button className="mx-2" onClick={decrementQuestion}>
                  <i className="bi bi-chevron-left"></i> Back
                </Button>
                <Button className="mx-2" onClick={incrementQuestion}>
          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              <Stack gap={2}>
                <h1>Question 5 </h1>
                <p>
                  Do you observe any of the following dietary religious laws?
                </p>
                <Stack className="p-1 d-flex justify-content-center">
                  <Form.Check
                    type="radio"
          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              <Stack gap={2}>
                <h1>Question 6 </h1>
                <p>
                  How important is nutritional value of the food you eat to you?
                  Rate 5 for very important, 0 for not important at all.
                </p>
                <Container className="p-1 d-flex justify-content-center">
                  <RangeSlider
                    value={nutritionScore}
                    onChange={(changeEvent) =>
                      setNutritionScore(changeEvent.target.value)
                    }
                    min={0}
                    max={5}
                  />
              ...
              <Stack gap={2}>
                ...
                <Container className="p-1 d-flex justify-content-center">
                  <RangeSlider
                    value={mealSwipes}
                    onChange={(changeEvent) =>
                      setMealSwipes(changeEvent.target.value)
                    }
                    min={7}
                    max={30}
                  />
          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              <Stack gap={2}>
                <h1>That's all!</h1>
                <p>
                  The data will be compiled and will help provide more accurate
                  recommendations for you!
                </p>
                <Button href={`/profile/${username}`}>
                  Head to Profile Page <i className="bi bi-chevron-right"></i>
                </Button>
              </Stack>
            </div>
          </Container>
          ...
          <Container style={{ paddingTop: "12vh" }}>
            <div className="p-3 my-4 mx-4 bg-light border rounded">
              <Stack gap={2}>
                ...
                <Button onClick={decrementQuestion}>
                  <i className="bi bi-chevron-left"></i> Back
                </Button>
              </Stack>
            </div>
