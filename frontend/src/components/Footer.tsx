...
function Footer(props: any) {
  ...
  return (
    <Container
      fluid
      className="p-5 position-absolute bg-light border justify-content-center"
    >
      <Stack>
        <Row>
          <Col className="p-2" xs={6} md={3}>
            <Stack>
              ...
              <div className="mx-auto">
                Boilerplate is an application intended to augment the dining
          ...
          <Col className="p-2 mx-auto" xs={6} md={3}>
            <Stack>
              ...
              <div className="mx-auto">
                <a href="/meal-plans/">Public Meal Plans</a>
              </div>
              <div className="mx-auto">
          ...
          <Col className="p-2" xs={6} md={3}>
            <Stack>
              ...
              <div className="mx-auto">
                <a href="https://github.com/agstatz/boilerplate/">
                  <i className="bi bi-github"></i> Github
                </a>
              </div>
              <div className="mx-auto">
                <a href="https://dining.purdue.edu/">
                  <i className="bi bi-search"></i> Purdue Dining
                </a>
              </div>
            </Stack>
          </Col>
        ...
        <hr />
        <div className="fs-6">
          Copyright Boilerplate © 2022. All rights reserved.
        </div>
      </Stack>
    </Container>
  );
